    ...
    public ResponseEntity<Object> handleStoreException(StoreException e) {
        ...
        if(errorCode == StoreErrorCode.INVALID_SOCON) {
            ...
            return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                    .body(MessageUtils.fail("" + errorCode, StoreErrorCode.INVALID_SOCON.getMessage()));
        }
        if(errorCode == StoreErrorCode.ALREADY_SAVED_STORE) {
            ...
            return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(MessageUtils.fail("" + errorCode, StoreErrorCode.ALREADY_SAVED_STORE.getMessage()));
        }
        if(errorCode == StoreErrorCode.ALREADY_SAVED_REGISTRATION_NUMBER) {
            log.error("already saved registration number, " + StoreErrorCode.ALREADY_SAVED_REGISTRATION_NUMBER.getMessage());
            return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(MessageUtils.fail("" + errorCode, StoreErrorCode.ALREADY_SAVED_REGISTRATION_NUMBER.getMessage()));
        }
        if(errorCode == StoreErrorCode.ALREADY_SET_CLOSE_PLAN) {
            ...
            return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(MessageUtils.fail("" + errorCode, StoreErrorCode.ALREADY_SET_CLOSE_PLAN.getMessage()));
        }
        ...
        if(errorCode == StoreErrorCode.STORE_NOT_FOUND) {
            ...
            return ResponseEntity.status(HttpStatus.NOT_FOUND).body(MessageUtils.fail("" + errorCode, StoreErrorCode.STORE_NOT_FOUND.getMessage()));
        }

        if(errorCode == StoreErrorCode.ITEM_NOT_FOUND) {
            log.error("item not found, " + StoreErrorCode.ITEM_NOT_FOUND.getMessage() + e.getMessage());
            return ResponseEntity.status(HttpStatus.NOT_FOUND).body(MessageUtils.fail("" + errorCode, StoreErrorCode.ITEM_NOT_FOUND.getMessage()));
        }
        if(errorCode == StoreErrorCode.ISSUE_NOT_FOUND) {
            ...
            return ResponseEntity.status(HttpStatus.NOT_FOUND).body(MessageUtils.fail("" + errorCode, StoreErrorCode.ISSUE_NOT_FOUND.getMessage()));
        }
        if(errorCode == StoreErrorCode.SOCON_NOT_FOUND) {
            ...
            return ResponseEntity.status(HttpStatus.NOT_FOUND).body(MessageUtils.fail("" + errorCode, StoreErrorCode.SOCON_NOT_FOUND.getMessage()));
        }
        if(errorCode == StoreErrorCode.REGISTRATION_NUMBER_NOT_FOUND) {
            ...
            return ResponseEntity.status(HttpStatus.NOT_FOUND).body(MessageUtils.fail("" + errorCode, StoreErrorCode.REGISTRATION_NUMBER_NOT_FOUND.getMessage()));
        }
