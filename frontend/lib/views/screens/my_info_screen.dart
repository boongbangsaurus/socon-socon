...
class _MyInfoScreen extends State<MyInfoScreen> {
  ...
  Widget userInfo(BuildContext context) {
    return Consumer<MyInfoProvider>(builder: (context, provider, child) {
      userData = provider.getUserInfo();
      return Container(
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Icon(
                            AppIcons.RIGHT,
                            size:
                                ResponsiveUtils.getWidthWithPixels(context, 25),
                          )
                        ],
                      )
                    ],
