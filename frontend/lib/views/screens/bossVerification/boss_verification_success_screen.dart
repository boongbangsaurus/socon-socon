...
class BossVerificationSuccessScreen extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _BossVerificationSuccessScreen();
}

class _BossVerificationSuccessScreen
    extends State<BossVerificationSuccessScreen> {
