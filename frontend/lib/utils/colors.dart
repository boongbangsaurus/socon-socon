...
class AppColors {
  ...
  static const Color YELLOW = Color(0XFFF8D461);
  static const Color PURPLE = Color(0XFFAE9DF5);
  static const Color GREEN = Color(0XFFB7E786);
  static const Color PINK = Color(0XFFFECEE4);
  static const Color GRAY = Color(0XFFF4F4F8);
  static const Color LIGHTBLUE = Color(0XFFECF0FF);

  // GRAY
  static const Color BACKGRAY = Color(0XFF818181);
  static const Color ToastGray = Color(0XFF404040);
